...
use function bundles\OtraUser\backoffice\services\addUser;

/**
 * @package bundles\OtraUser\backoffice\controllers\index
 */
class AddUserAction extends Controller
{
  /**
  ...
  public function __construct(array $otraParams = [], array $params = [])
  {
    ...
    require BUNDLES_PATH . 'OtraUser/backoffice/services/addUser.php';
    addUser(
