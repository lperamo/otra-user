...
class EditUserActionTest extends TestCase
{
  ...
  protected function tearDown(): void
  {
    ...
    $query = 'UPDATE `' . UserService::TABLE_USER .
      '` SET fk_id_role=2, mail=\'contact@website2.com\',
        pwd=\'$2y$10$Vps8t9vwk/cgIQdagIf16eXbJujb3luT0k3byEdC4Yxdk0N.bhW.m\',
        pseudo=\'MrPaul\',
        first_name=\'Paul\',
        last_name=\'Brown\',
        token=NULL
